...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::post('/dashboard/product/store', [App\Http\Controllers\DashboardProductController::class, 'store'])->name('dashboard-product-store');
    ...
    Route::get('/dashboard/product/gallery/delete/{id}', [App\Http\Controllers\DashboardProductController::class, 'deleteGallery'])->name('dashboard-product-gallery-delete');
