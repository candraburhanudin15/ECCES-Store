...
@section('content')
    ...
    <section class="store-cart">
                            ...
                            <td style="width: 20%;" class="align-middle">
                              ...
                              <td style="width: 20%;" class="align-middle">
                                <form action="{{ route('cart-delete', $cart->id) }}" method="POST">
                                  @method('DELETE')
                                  @csrf
                                  <button class="m-4 btn btn-remove-cart text-white" type="submit">
                                    Remove
                                  </button>
                                </form>
                              </td>
        ...
        <form id="locations" action="{{ route('checkout') }}" enctype="multipart/form-data" method="POST">
            @csrf
            ...
            <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="provinces_id" class="form-control" id="provinces_id" v-model="provinces_id" v-if="provinces">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="regencies_id" class="form-control" id="regencies_id" v-model="regencies_id" v-if="regencies">
